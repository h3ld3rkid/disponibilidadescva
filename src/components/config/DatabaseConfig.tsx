    ...
    try {
      ...
      if (result) {
        toast({
          ...
          description: "A configuração da base de dados foi salva com sucesso.",
          variant: "default",
        });
      } else {
        toast({
    ...
    <div className="max-w-3xl mx-auto">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground">
          Configure os parâmetros de conexão para a base de dados local.
        </p>
      </div>
      ...
      <div className="mt-6">
        <Alert>
          <AlertDescription>
            <strong>Nota:</strong> Após alterar a configuração da base de dados, poderá ser necessário fazer login novamente.
          </AlertDescription>
        </Alert>
      </div>
    </div>
