-- Simple database recreation without touching auth tables
-- Drop all existing public tables and functions
...
-- Create users table (simple structure) - without RLS initially
...
-- Create all other tables without RLS
...
VALUES (
  ...
  'A base de dados foi completamente recriada e está agora funcional.',
  now(),
